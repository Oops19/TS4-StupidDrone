...
The TS4 "Drone" will no longer be monitored or stopped by TS4 AI when Sims engage in "inappropriate" actions that should never be recorded or streamed.

With this mod, Sims — including those from "Get Famous" — can live-stream even while showering or woohooing, as expected by their reality TV audience.

### ⚙️ Technical details
The TS4 drone does not actually record or stream anything.
After "recording," it simply creates an object with a title and description.
This behavior remains unchanged.

Resetting a Sim will also reset the drone attached to them and stop any recording or streaming in progress.
